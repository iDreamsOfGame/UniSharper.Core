...
namespace UniSharper.Extensions
{
    ...
    public static class Color32Utility
    {
        ...
        /// <summary>
        /// Converts the collection of <see cref="byte"/> representation of an <see cref="Color32"/> array equivalent.
        /// </summary>
        /// <param name="values">The collection of <see cref="byte"/> representation of an <see cref="Color32"/> array equivalent.</param>
        /// <returns>An <see cref="Color32"/> array equivalent to the <c>values</c>. </returns>
        public static Color32[] ParseArray(IList<byte> values)
        {
        ...
        /// </summary>
        /// <param name="values">The collection of <see cref="byte"/> representation of an <see cref="Color32"/> array equivalent. </param>
        /// <param name="result">An <see cref="Color32"/> array equivalent to the <c>values</c>. </param>
        /// <returns><c>true</c> if <c>values</c> was converted successfully; otherwise, <c>false</c>. </returns>
        public static bool TryParseArray(IList<byte> values, out Color32[] result)
        {
